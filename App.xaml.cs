...
namespace Medium
{
    ...
    {
        public static ServiceClient MediumClient;
        ...
        public App()
        {
            ...
            MediumClient = new ServiceClient(Debugger.IsAttached);

            Resources.Remove("PhoneAccentColor");
            Resources.Add("PhoneAccentColor", Color.FromArgb(255, 87, 173, 104));

            ((SolidColorBrush)Resources["PhoneAccentBrush"]).Color = Color.FromArgb(255, 87, 173, 104);
